...
}else if (get_field('who_national_2017_safely_managed') < 20 && get_field('who_national_2017_safely_managed') != 0){
...
<!-- wp:paragraph -->
<p>Currently, there is no available public data about water quality in <?php the_field('city_name'); ?>. But the average water quality in <?php echo $country_name; ?> is <?php echo get_field('water_quality', $stateID); ?>%.</p>
<!-- /wp:paragraph -->
<?php endif; ?>
<?php
if(get_field('who_national_2017_basic', $stateID)){
?>
<p>According to WHO data, <?php echo get_field('who_national_2017_basic', $stateID); ?>% of <?php echo $country_name; ?> cities/towns and rural areas have access to improved water sources, that are available when needed.
</p>
<?php
}else{
?>
<p>There was no general information available in WHO data about safely managed drinking water in <?php echo $country_name; ?>.
...
<!-- wp:heading -->
<h2>What Do People In <?php echo $country_name; ?> Think About The Tap Water?</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Travelers and residents of <?php echo $country_name; ?> have rated the water quality and pollution as follows, according to subjective survey data.
<!-- /wp:paragraph -->
    ...
    <ul>
        <li>
            ...
            <span class="water-quality-graph__container">
                <span class="water-quality-graph__bar inv" data-size="<?php echo $inaccessability; ?>"><span class="water-quality-graph__bar-tooltip"><?php echo $inaccessability.'% '.$drinking_water_pollution_and_inaccessibility_rating; ?><span class="dashicons dashicons-arrow-down"></span></span>
            </span>
        </li>
        <li>
            <span class="water-quality-graph__title">Water Pollution</span>
            <span class="water-quality-graph__container">
                <span class="water-quality-graph__bar inv" data-size="<?php echo $waterpollution; ?>"><span class="water-quality-graph__bar-tooltip"><?php echo $waterpollution.'% '.$water_pollution_rating; ?><span class="dashicons dashicons-arrow-down"></span></span>
            </span>
        </li>
        <li>
            <span class="water-quality-graph__title">Drinking Water Quality and Accessibility</span>
            <span class="water-quality-graph__container">
                <span class="water-quality-graph__bar" data-size="<?php echo $accessibility; ?>"><span class="water-quality-graph__bar-tooltip"><?php echo $accessibility.'% '.$drinking_water_quality_and_accessibility_rating; ?><span class="dashicons dashicons-arrow-down"></span></span>
            </span>
        </li>
        <li>
            <span class="water-quality-graph__title">Water Quality</span>
            <span class="water-quality-graph__container">
                <span class="water-quality-graph__bar" data-size="<?php echo $waterquality; ?>"><span class="water-quality-graph__bar-tooltip"><?php echo $waterquality.'% '.$water_quality_rating; ?><span class="dashicons dashicons-arrow-down"></span></span>
            </span>
        </li>
...
//show more countries in same continent
    ...
    if($query->have_posts())://do not display if only one city in country  == current city
        ...
        while($query->have_posts()):
            ...
            ?>
               <li class="country-list-item"><a href="<?php the_permalink(); ?>"><?php the_field('country_name'); ?></a></li>
            <?php
            endif;
