const mymap = L.map('map-container', { preferCanvas: true, gestureHandling: true }).setView([51.505, -0.09], 2);
...
const geojsonLayerCountries = new L.GeoJSON.AJAX("wp-content/themes/tapwater/map/geojson/countries.geojson", {
  style: countriesStyle,
  onEachFeature: onEachFeature,
});

const geojsonLayerCountriesNoUs = new L.GeoJSON.AJAX("wp-content/themes/tapwater/map/geojson/countries.geojson", {
  style: countriesStyle,
  onEachFeature: onEachFeature,
  filter: usFilter
});

const geojsonLayerStates = new L.GeoJSON.AJAX("wp-content/themes/tapwater/map/geojson/us_states.geojson", {
  style: countriesStyle,
  onEachFeature: onEachFeature,
});

const geojsonLayerCities = new L.GeoJSON.AJAX("wp-content/themes/tapwater/map/geojson/us_cities.geojson", {
...
const geojsonLayerWorldCities = new L.GeoJSON.AJAX("wp-content/themes/tapwater/map/geojson/world_cities.geojson", {
  pointToLayer: function(geoJsonPoint, latlng) {
    return L.circleMarker(latlng);
  },
  style: function(feature) {
